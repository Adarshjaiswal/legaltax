              ...
              <form  action="mail_handler.php" method="POST">
                ...
                <div class="row">
                  <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Phone" name="tel" required pattern="[6789][0-9]{9}">
                  </div>
                  <div class="form-group col-12">
                  ...
                  <!-- <div class="col-12 text-center">
                    ...
                    <button type="submit" name="Submit" id="contact-submit" class="pulse-button" data-submit="...Sending">Book Now</button>
                  </div>
